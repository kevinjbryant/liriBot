...
var app = {
  ...
  "spotify-this-song": function(keyword) {
    spotify.search({ type: 'track', query: keyword || 'Overflow' }, function(err, data) {
      if ( err ) {
  ...
  "movie-this": function(query) {
    request('http://www.omdbapi.com/?t=' + (query || 'Lion King') +'&tomatoes=true', function (error, response, info) {
